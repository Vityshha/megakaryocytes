...
for file_path in tqdm(glob.glob(PATH + '/*.tif'), desc="Processing images"):
    ...
    MAX_AREA = image.shape[0] * image.shape[1] * MAX_AREA_COEFF
    ...
    if NEED_SHOW_RESULT:
        ...
        # Считаем количество изображений для показа (основное + ядра)
        ...
        # Показ изображений на одном графике
